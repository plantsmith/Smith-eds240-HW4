...
-   **4.** What question(s) do you hope to answer using these data (remember to read over Enrico Bertini’s [article](https://filwd.substack.com/p/asking-the-right-data-questions-andon%20how%20to%20ask%20the%20right%20questions))?
    ...
    I'm still brainstorming possibilities, but here are some initial thoughts:

    -   Overarching question/story: How have air pollution levels in Los Angeles changed over time, and what are the contributing factors and impacts on residents? —\> this may be too broad
