...
# View(palettes_d_names) #discrete 
# View(palettes_c_names) #continuous

# # Display the discrete "eschscholzia" palette
# paletteer::paletteer_d("calecopal::eschscholzia")
# # Extract the full palette as a vector
# full_pal <- paletteer::paletteer_d("calecopal::eschscholzia")
# # Choose colors
# custom_pal <- full_pal[c(1, 4)]

####
# # Display the discrete "canary" palette
# paletteer::paletteer_d("calecopal::canary")
# # Extract the full palette as a vectorz
# full_pal <- paletteer::paletteer_d("calecopal::canary")
# # Choose colors
# custom_pal_1 <- full_pal[c(1, 4)]
